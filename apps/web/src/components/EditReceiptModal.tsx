  ...
  return (
    <div className="print-portal fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-inkDark/50 backdrop-blur-[3px] p-4 print:bg-white print:p-0 print:static print:overflow-visible print:block">
      ...
      >
        ...
        <div className="receipt-body px-5 py-4 text-[12px] text-ink">
          {/* Header */}
          <div className="flex items-start justify-between gap-3 pb-3 border-b-2 border-brand">
            ...
            <div className="text-right shrink-0">
              ...
              <div className="mt-1.5">
                <label className="text-[9px] uppercase tracking-wider text-inkMuted font-semibold block mb-0.5">
                  Date & Time
                </label>
                <input
                  type="datetime-local"
                  className="input !min-h-[28px] !h-7 !text-[11px] !py-0.5 w-[150px] text-right font-mono"
                  value={paymentDate}
          ...
          <div className="grid grid-cols-2 gap-2 mt-3">
            ...
            <div className="border border-divider rounded-lg bg-surfaceAlt p-2.5">
              ...
              <div className="grid grid-cols-2 gap-2 mt-1">
                <div>
                  <div className="text-[9px] uppercase tracking-wider text-brand-deep font-bold">
                    Check-in
                  </div>
              ...
              <tbody>
                {data.rooms.map((rm) => (
                  <tr key={rm.roomNumber}>
                    <td className="py-1.5 border-b border-divider font-mono font-bold">
                      {rm.roomNumber}
                    </td>
          ...
          {data.latestPayment && (
            <div className="mt-4 p-3 rounded-sm text-cream bg-inkDark">
              ...
              <div className="grid grid-cols-2 gap-2 mt-3 text-cream">
                <label className="block">
                  ...
                  <select
                    className="w-full !text-[11px] !h-7 rounded-sm bg-cream text-ink px-2 outline-none border border-inkDark/20 focus:border-brass"
                    value={method}
          ...
          <div className="mt-4 pt-3 border-t border-divider text-[10px] text-inkMuted leading-relaxed">
            Amount and receipt number are locked for audit integrity. To change the amount, void
            this payment and record a new one.
          </div>

          {error && (
            <div className="mt-3 px-3 py-2 rounded-md border border-dangerBorder bg-dangerBg text-dangerFg text-[11px]">
              {error}
            </div>
          )}
        </div>
