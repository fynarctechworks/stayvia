// Animated "silk" backdrop — a full-canvas WebGL shader from React Bits.
// Heavy (pulls in three + @react-three/fiber), so it is lazy-loaded only
// where it's used (the login page) via React.lazy.
