    ...
    <div className="space-y-4">
      ...
      {listQ.isError ? (
        ...
        <div className="card !p-0 overflow-hidden">
          <div className="hidden lg:grid grid-cols-[150px_140px_minmax(180px,1fr)_90px_120px_120px_120px_120px] gap-3 px-3 py-2.5 text-[10px] font-bold uppercase tracking-[0.06em] text-inkMuted bg-surfaceAlt border-b border-divider">
            <div>Invoice #</div>
            <div>Issued</div>
            <div>Billed to</div>
            <div>Scope</div>
...
function InvoiceRow({
  ...
  return (
    <li className="group hover:bg-surfaceAlt transition-colors">
      {/* DESKTOP */}
      <div className="hidden lg:grid grid-cols-[150px_140px_minmax(180px,1fr)_90px_120px_120px_120px_120px] gap-3 items-center px-3 py-2.5">
